...
export class ExtensionPopup extends LitElement {
    ...
    render() {
        return html`
            <popup-header> EthiGuard </popup-header>
...
//     reportLink = this.results.countVisible
//   ? <a href="https://darkpatternstipline.org/report/">Report this to authorities here!</a>
//   : <p>Nothing to report here, Have a great day!</p>;
